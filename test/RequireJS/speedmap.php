     ...
     <li><a href="elige.php">INTERNET HOGAR</a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
           ...
           <li role="separator" class="divider"></li>
            <li class="active"><a href="speedmap.php">VELOCIDAD</a></li>
...
if(porcentaje<1){
 var color='#FF0000';
    //   var text4 = document.createElement('text');
           //   text4.textContent = "EFICIENCIA:"+porcentaje*10 + "/100%";
...
var image = {
    url: 'https://www.velocidaddeinternet.cl/green.png',
