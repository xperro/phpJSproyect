...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# N° MEDICIONES',
            data: [<?echo $countervtr;?> , <?echo $countermovi;?>, <?echo $counterentel;?>, <?echo $counterclaro;?>, <?echo $counterwom;?>,<?echo $countergtd;?>],
              backgroundColor: [
            "#FF6384",
            "#4BC0C0",
            "#FFCE56",
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [<?echo round($maxvtr,1);?> , <?echo round($maxmovi,1);?>, <?echo round($maxentel,1);?>, <?echo round($maxclaro,1);?>, <?echo round($maxwom,1);?>,<?echo round($maxgtd,1);?>],
            backgroundColor: [
                  'rgba(0, 210, 25, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)',
