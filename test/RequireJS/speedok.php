...
$plan=0;
$host=gethost($_SERVER['REMOTE_ADDR']);
...
<header>
   ...
   <form class="form" method="post" action="sendinfo.php" >
...
<select style="width:100%;height: 30px;" name="plan" id="ddlViewBy" value="S">
  ...
  <option value="10">Plan 3G</option>
  <option value="20">Plan 4G Normal</option>
    <option value="20">Plan 4G+</option>
