...
box-shadow: -1px 2px 18px -1px rgba(0,0,0,1);
        ...
        html, body, #map{font-family: 'Work Sans', sans-serif;
        width: 100%;
        height: 100%;
    }
    #formContent{
   ...
   <li class="dropdown">
     ...
     <li><a href="elige.php">INTERNET HOGAR</a></li>
        ...
        <li class="dropdown">
          ...
          <li class="active"><a href="ispmap.php">ISP</a></li>
...
if(compania=="TELEFONICA SUR"){bol=true;
    var variable=<? echo $gtd/$countergtd ;?>;
       var image="https://www.velocidaddeinternet.cl/images/telef2.png";
}
if(compania=="TELMEX"){bol=true;
    var variable=<? echo $gtd/$countergtd ;?>;
       var image="https://www.velocidaddeinternet.cl/images/telmex.png";
}
if(compania=="PACIFICO CABLE"){bol=true;
    var variable=<? echo $gtd/$countergtd ;?>;
       var image="https://www.velocidaddeinternet.cl/images/mundo.png";
}
if(bol==false){
  compania="OTRO";
  var variable=<? echo $gtd/$countergtd ;?>;
