...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# EFICIENCIA  %',
            data: [<?echo round($efivtr/$countervtr,1)*100;?> , <?echo round($efimovi/$countermovi,1)*100;?>, <?echo round($efientel/$counterentel,1)*100;?>, <?echo round($eficlaro/$counterclaro,1)*100;?>,<?echo round($efigtd/$countergtd,1)*100;?>,<?echo round($efitelef/$countertelef,1)*100;?>,<?echo round($efiotro/$counterotro,1)*100;?>],
            backgroundColor: [
                  'rgba(0, 210, 25, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)',
