...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [<?echo round($speeduser/$speedcounter,1);?>,<?echo round($vtr/$countervtr,1);?> , <?echo round($movi/$countermovi,1);?>, <?echo round($entel/$counterentel,1);?>, <?echo round($claro/$counterclaro,1);?>, <?echo round($wom/$counterwom,1);?>,<?echo round($gtd/$countergtd,1);?>],
            backgroundColor: [
             'rgba(0, 210, 25, 0.2)',
                'rgba(255, 99, 132, 0.2)',
                'rgba(54, 162, 235, 0.2)',
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# EFICIENCIA  %',
            data: [<?echo round($efivtr/$countervtr,1)*100;?> , <?echo round($efimovi/$countermovi,1)*100;?>, <?echo round($efientel/$counterentel,1)*100;?>, <?echo round($eficlaro/$counterclaro,1)*100;?>, <?echo round($efiwom/$counterwom,1)*100;?>,<?echo round($efigtd/$countergtd,1)*100;?>],
            backgroundColor: [
                  'rgba(0, 210, 25, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)',
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [<?echo round($velocidad,1);?>,<?echo round($maxvtr,1);?> , <?echo round($maxmovi,1);?>, <?echo round($maxentel,1);?>, <?echo round($maxclaro,1);?>, <?echo round($maxwom,1);?>,<?echo round($maxgtd,1);?>],
            backgroundColor: [
                  'rgba(0, 210, 25, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)',
...
<span style="color: white;">© 2017  velocidaddeinternet.cl Todos los derechos reservados.</span>
</span>
</div>
</div>
