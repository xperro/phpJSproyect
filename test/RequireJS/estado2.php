          ...
          <ul class="dropdown-menu">
            ...
            <li role="separator" class="divider"></li>
              ...
              <li><a href="estado1.php">INTERNET HOGAR</a></li>
                <li class="active"><a href="estado2.php">INTERNET MÓVIL</a></li>
              <li role="separator" class="divider"></li>
...
var myChart = new Chart(ctx, {
    type: 'bar',
    data: {
        labels: ["VTR", "MOVISTAR", "ENTEL", "CLARO", "WOM","GTD","TELEFONICA SUR","OTRO"],
        datasets: [{
            label: '# Velocidad Media Nacional Mbps',
            data: [<?echo round($vtr/$countervtr,1);?> , <?echo round($movi/$countermovi,1);?>, <?echo round($entel/$counterentel,1);?>, <?echo round($claro/$counterclaro,1);?>, <?echo round($wom/$counterwom,1);?>,<?echo round($gtd/$countergtd,1);?>,<?echo round($telef/$countertelef,1);?>,<?echo round($otro/$counterotro,1);?>],
            backgroundColor: [
             'rgba(0, 210, 25, 0.2)',
                'rgba(255, 99, 132, 0.2)',
                'rgba(54, 162, 235, 0.2)',
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# EFICIENCIA  %',
            data: [<?echo round($efivtr/$countervtr,1)*100;?> , <?echo round($efimovi/$countermovi,1)*100;?>, <?echo round($efientel/$counterentel,1)*100;?>, <?echo round($eficlaro/$counterclaro,1)*100;?>, <?echo round($efiwom/$counterwom,1)*100;?>,<?echo round($efigtd/$countergtd,1)*100;?>,<?echo round($efitelef/$countertelef,1)*100;?>,<?echo round($efiotro/$counterotro,1)*100;?>],
            backgroundColor: [
                  'rgba(0, 210, 25, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)',
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# N° MEDICIONES',
            data: [<?echo $ctvtr;?> , <?echo $ctmovi;?>, <?echo $ctentel;?>, <?echo $ctclaro;?>, <?echo $ctwom;?>,<?echo $ctgtd;?>,<?echo $cttelef;?>,<?echo $ctotro;?>],
              backgroundColor: [
            "#FF6384",
            "#4BC0C0",
            "#FFCE56",
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [<?echo round($maxvtr,1);?> , <?echo round($maxmovi,1);?>, <?echo round($maxentel,1);?>, <?echo round($maxclaro,1);?>, <?echo round($maxwom,1);?>,<?echo round($maxgtd,1);?>,<?echo round($maxtelef,1);?>,<?echo round($maxotro,1);?>],
            backgroundColor: [
                  'rgba(0, 210, 25, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)',
