...
<nav class="navbar navbar-default navbar-fixed-top" style="margin-bottom: 0px;"> <a class="navbar-brand" href="index.php" style="padding: 8px 0px !important;"><img src="images/logo.png"></a>
   ...
   <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="active"><a href="misresultados.php"><strong style="color:#16bd00;">MIS RESULTADOS</strong></a></li>
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [<?echo round($speeduser/$speedcounter,1);?>,<?echo round($vtr/$countervtr,1);?> , <?echo round($movi/$countermovi,1);?>, <?echo round($entel/$counterentel,1);?>, <?echo round($claro/$counterclaro,1);?>, <?echo round($wom/$counterwom,1);?>,<?echo round($telef/$countertelef,1);?>,<?echo round($gtd/$countergtd,1);?>],
            backgroundColor: [
             'rgba(0, 210, 25, 0.2)',
                'rgba(255, 99, 132, 0.2)',
                'rgba(54, 162, 235, 0.2)',
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: '# EFICIENCIA  %',
            data: [<?echo round($efivtr/$countervtr,1)*100;?> , <?echo round($efimovi/$countermovi,1)*100;?>, <?echo round($efientel/$counterentel,1)*100;?>, <?echo round($eficlaro/$counterclaro,1)*100;?>, <?echo round($efiwom/$counterwom,1)*100;?>,<?echo round($efitelef/$countertelef,1)*100;?>,<?echo round($efigtd/$countergtd,1)*100;?>],
            backgroundColor: [
                  'rgba(0, 210, 25, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)',
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [<?echo round($speeduser/$speedcounter,1);?>,<?echo round($maxvtr,1);?> , <?echo round($maxmovi,1);?>, <?echo round($maxentel,1);?>, <?echo round($maxclaro,1);?>, <?echo round($maxwom,1);?>,<?echo round($maxtelef,1);?>,<?echo round($maxgtd,1);?>],
            backgroundColor: [
                  'rgba(0, 210, 25, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)',
...
if($var==1){
 ...
 $fecha1= substr($fila['hora'], 0, 10);
 $velocidad1=$fila['velocidad'];
}
if($var==2){
  $fecha2=substr($fila['hora'], 0, 10);
 $velocidad2=$fila['velocidad'];;
}

if($var==3){
 $fecha3=substr($fila['hora'], 0, 10);
 $velocidad3=$fila['velocidad'];;
}

if($var==4){
 $fecha4=substr($fila['hora'], 0, 10);
 $velocidad4=$fila['velocidad'];;
}

if($var==5){
  $fecha5=substr($fila['hora'], 0, 10);
...
<span style="color: black;font-size: 12px;">© 2017   info@velocidaddeinternet.cl- <a target="_blank" href="https://www.informatica2017.cl">informatica2017 Todos los derechos reservados.</a></span>
</span>
</div>
</div>
