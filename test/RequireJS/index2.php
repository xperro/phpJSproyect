 ...
 <li style="background-color: #eee;">
    ...
    <div class="cd-slider-nav">
      <nav>
        ...
        <ul>
          <li class="selected"><a href="#1">HOME</a></li>
          <li><a href="#2">DIAGNÓSTICO</a></li>
          <li><a href="#3">RESULTADOS</a></li>
          <li><a href="#4">EVALUACIÓN</a></li>
        </ul>
      </nav> 
    </div> <!-- .cd-slider-nav -->
  </section> <!-- .cd-hero -->
...
<div class="" id="service" >
        ...
        <div class="col-xs-3 col-md-3 service-box hvr-float-shadow">
          ...
          <div class="col-xs-3 col-md-3 service-box hvr-float-shadow">
            ...
            <p>Para poder realizar el diagnóstico debe usar IE,Chrome, Safari, Firefox, o Opera.</p>
          </div>
...
<span style="color: black; font-size: 12px;">© 2017  info@velocidaddeinternet.cl - <a target="_blank"href="www.informatica2017.cl">informatica2017</a> Todos los derechos reservados.</span>
</span>
</div>
</div>
